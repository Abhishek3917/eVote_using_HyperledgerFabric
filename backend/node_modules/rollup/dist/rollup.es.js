/*
	Rollup.js v0.61.2
	Sat, 23 Jun 2018 07:08:10 GMT - commit 8b582b54151f59043e11dfb0f3ad7cdb90f8ad50
...
function firstSync(candidates) {
    return function () {
        ...
        return candidates.reduce(function (result, candidate) {
            return result != null ? result : candidate.call.apply(candidate, [_this].concat(args));
        }, null);
    };
}
...
var Graph = /** @class */ (function () {
    function Graph(options, watcher) {
        ...
        this.pluginContext = __assign({ watcher: watcher, isExternal: undefined, resolveId: undefined, parse: this.contextParse, warn: function (warning) {
                if (typeof warning === 'string')
                    warning = { message: warning };
                _this.warn(warning);
            }, error: function (err) {
